package com.prosidney.inventory.web.rest;

import static com.prosidney.inventory.web.rest.TestUtil.sameNumber;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.prosidney.inventory.IntegrationTest;
import com.prosidney.inventory.domain.Product;
import com.prosidney.inventory.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).quantity(DEFAULT_QUANTITY).price(DEFAULT_PRICE);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).quantity(UPDATED_QUANTITY).price(UPDATED_PRICE);
        return product;
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).quantity(UPDATED_QUANTITY).price(UPDATED_PRICE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).quantity(UPDATED_QUANTITY).price(UPDATED_PRICE);
